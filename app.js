...
var UIController = (function() {
    ...
    return {
        ...
        addListItem : function(obj, type) {
            ...
            // Create HTML String with Placeholer
            if (type === 'inc') {
                elemnet = DOMstrings.incomeContainer;

                html = '<div class="item clearfix" id="inc-%id%"> <div class="item__description">%description%</div><div class="right clearfix"><div class="item__value">%value%</div><div class="item__delete"><button class="item__delete--btn"><i class="ion-ios-close-outline"></i></button></div></div></div>';
            } else {
                elemnet = DOMstrings.expensesContainer;

                html = '<div class="item clearfix" id="exp-%id%"><div>%description%</div><div class="right clearfix"><div class="item__value">%value%</div><div class="item__percentage">21%</div><div class="item__delete"><button class="item__delete--btn"><i class="ion-ios-close-outline"></i></button></div></div></div>';
            }
        ...
        displayDate: function() {
            ...
            monthArr = ['Januray', 'Febraury', 'March','April', 'May', 'June', 'July', 'August', 'September', 'October', 'Novamber', 'December'];
            now = new Date();
